...
$page_title = 'إضافة نشاط تجاري جديد - Syriazzle';
...
<head>
    ...
    <title>إضافة نشاط تجاري جديد</title>
    
    <!-- استدعاء ملفات CSS المحلية -->
    <link rel="stylesheet" href="css/lib/leaflet.css" />
    <link rel="stylesheet" href="css/lib/geosearch.css" />
    
    <!-- ملفات التنسيق الخاصة بالموقع -->
    <link rel="stylesheet" href="css/all.min.css" />
    <link rel="stylesheet" href="css/main_header.css">
    <link rel="stylesheet" href="css/add_business_form.css">
    
    <!-- استدعاء ملفات JS المحلية -->
    <script src="js/lib/leaflet.js"></script>
    <script src="js/lib/geosearch.js"></script> <!-- تأكد أن اسم الملف لديك هو geosearch.js كما في الصورة -->
    
    <style>
        /* ... (نفس التنسيقات الداخلية الموجودة سابقاً لا تغيير عليها) ... */
        ...
        .summary-img { width: 50px; height: 50px; border-radius: 8px; object-fit: cover; border: 1px solid #eee; }
        .summary-info { flex-grow: 1; display: flex; flex-direction: column; }
        .summary-name { font-weight: 700; font-size: 15px; color: #333; }
        .summary-price { font-size: 13px; color: #198754; font-weight: 600; }
...
<body>
    ...
    <div class="form-container">
        <form id="add-business-form" action="php/save_business_user.php" method="POST" enctype="multipart/form-data">
            ...
            <!-- شريط الخطوات (Wizard Progress Bar) -->
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            <label for="name">اسم النشاط التجاري <span style="color:red">*</span></label>
                            <input type="text" id="name" name="name" required>
                        </div>
                        <div class="form-group">
                            <label for="category">الفئة الرئيسية <span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="governorate_id">المحافظة <span style="color:red">*</span></label>
                        ...
                        <div class="form-group"><label for="city">المدينة <span style="color:red">*</span></label><input type="text" id="city" name="city" required></div>
                        <div class="form-group">
                            <label for="currency">عملة المتجر وتغعير المنتجات <span style="color:red">*</span></label>
                            <select id="currency" name="currency" required style="background-color: #f0f8ff; border: 1px solid #007bff;">
                            ...
                            <small style="color: #6c757d; display: block; margin-top: 5px; font-size: 12px;">
                                <i class="fas fa-info-circle"></i> تنبيه: سيتم اعتماد هذه العملة لجميع منتجات المتجر.
                            </small>
                        </div>
                        <div class="form-group full-width"><label for="address">العنوان التفصيلي</label><input type="text" id="address" name="address"></div>
                        ...
                        <div class="form-group">
                            <label for="video_url">رابط فيديو ترويجي (YouTube, Facebook)</label>
                            <input type="url" id="video_url" name="video_url" placeholder="https://...">
                        </div>
                    </div>
                    <div class="form-group full-width" id="map-section">
            ...
            <div class="tab-pane" id="step-1">
                <p id="details-placeholder-message" style="text-align: center; color: #6c757d; padding: 40px; border: 2px dashed #eee; border-radius: 8px;">
                    الرجاء اختيار "الفئة الرئيسية" في الخطوة السابقة لعرض التفاصيل الخاصة بها.
                </p>
                            ...
                            <div class="image-uploader-group">
                                <div class="image-uploader-box" id="logo-uploader-box">
                                    ...
                                    <div class="upload-content">
                                        ...
                                        <div class="upload-text">اختر الشعار</div>
                                    </div>
                                </div>
                            ...
                            <div class="image-uploader-group">
                                <div class="image-uploader-box" id="cover-uploader-box">
                                    ...
                                    <div class="upload-content">
                                        ...
                                        <div class="upload-text">اختر صورة الغلاف</div>
                                    </div>
                                </div>
                    ...
                    <div class="form-group full-width">
                        <div class="image-uploader-group">
                            <div class="image-uploader-box" id="gallery-uploader-box">
                                ...
                                <div class="upload-content">
                                    <i class="fas fa-photo-video upload-icon"></i>
                                    <div class="upload-text">اختر صورًا إضافية (متعدد)</div>
                                </div>
                            </div>
            ...
            <div class="tab-pane" id="step-3">
                <div class="form-section">
                    ...
                    <p style="margin-top: -15px; color: #6c757d;">
                        أضف صوراً للعروض المميزة أو المنتجات الأكثر مبيعاً. ستظهر هذه الصور في سلايدر جذاب في أعلى صفحة متجرك.
                    </p>
                    <div class="form-group full-width">
                        <div class="image-uploader-group">
                            <div class="image-uploader-box" id="offers-uploader-box">
                                ...
                                <div class="upload-content">
                                    <i class="fas fa-photo-video upload-icon"></i>
                                    <div class="upload-text">اختر صور العروض (متعدد، 5 صور كحد أقصى)</div>
                                </div>
                            </div>
            ...
            <!-- الخطوة 5: العروض والصفقات -->
            <div class="tab-pane" id="step-4">
                <div class="form-section">
                    <h2><i class="fas fa-tags"></i> العروض والصفقات الخاصة</h2>
                    <p style="margin-top: -15px; color: #6c757d;">(الحد الأقصى: 20 عرض في هذه المرحلة).</p>
            ...
            <div class="tab-pane" id="step-5">
                <div class="form-section">
                    <h2><i class="fas fa-clipboard-list"></i> قائمة الأسعار / الخدمات</h2>
                    <p style="margin-top: -15px; color: #6c757d;">(الحد الأقصى: 20 عنصر في هذه المرحلة).</p>
                    <div id="menu-items-container"></div>
                    <button type="button" id="add-menu-item-btn"><i class="fas fa-plus"></i> إضافة عنصر جديد</button>
                </div>
            </div>

            <!-- الخطوة 7: ساعات العمل (اجباري) -->
            ...
            <!-- أزرار التنقل السفلية (Wizard Controls) -->
            <div class="form-navigation">
                ...
                <button type="button" class="btn-nav btn-submit" id="submitBtn" onclick="nextPrev(1)">إرسال للمراجعة</button>
            </div>
...
<script>
    ...
    function nextPrev(n) {
        ...
        if (nextStep >= x.length) {
            ...
            document.getElementById("submitBtn").innerHTML = "جارٍ الإرسال...";
            return false;
        }
        currentTab = nextStep;
        showTab(currentTab);
        ...
        for (let i = 0; i < currentInputs.length; i++) {
            ...
            if (input.hasAttribute("required")) {
                ...
                if (input.value.trim() === "") {
                    ...
                    const parentEntry = input.closest('.menu-item-entry, .deal-entry');
                    
                    if (parentEntry && parentEntry.classList.contains('collapsed')) {
                        parentEntry.classList.remove('collapsed');
                    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // --- المنيو (بتصميم البطاقات الحديث والطي) ---
        ...
        function updateCategoryTags(entry) {
            ...
            allTags.forEach(category => {
                ...
                tag.onclick = (e) => {
                    e.stopPropagation(); // منع طي البطاقة
                    entry.querySelector('.hidden-category-input').value = category;
                    entry.querySelector('.category-input').value = category;
        ...
        function addMenuItemEntry() {
            ...
            entryDiv.className = 'menu-item-entry'; // كرت مفتوح
            const idx = menuItemCounter++;
            
            entryDiv.innerHTML = `
                <!-- ملخص البطاقة (للظهور عند الطي لاحقاً) -->
                <div class="collapsed-summary">
                    <img src="image/default_logo.webp" class="summary-img" alt="">
                    <div class="summary-info">
                        <span class="summary-name">عنصر جديد</span>
                        <span class="summary-price">0 ل.س</span>
                    </div>
                ...
                <div class="menu-item-fields">
                    ...
                    <div class="fields-grid">
                        ...
                        <div class="form-group"><label>السعر*</label><input type="number" name="menu_items[${idx}][price]" placeholder="الإدخال بالليرة السورية" class="form-control price-input price-live-update" required></div>
            ...
            entryDiv.querySelector('.add-category-btn').addEventListener('click', (e) => {
                ...
                if(val) { userCreatedCategories.add(val); entryDiv.querySelector('.hidden-category-input').value = val; document.querySelectorAll('.menu-item-entry').forEach(updateCategoryTags); }
            });
        }
        addMenuItemBtn.addEventListener('click', addMenuItemEntry);
        categorySelect.addEventListener('change', () => document.querySelectorAll('.menu-item-entry').forEach(updateCategoryTags));
        addMenuItemEntry();
        ...
        function addDealItemEntry() {
            ...
            entryDiv.innerHTML = `
                <div class="collapsed-summary">
                    <img src="image/default_logo.webp" class="summary-img" alt="">
                    <div class="summary-info"><span class="summary-name">عرض جديد</span><span class="summary-price">0 ل.س</span></div>
                    <i class="fas fa-chevron-down expand-icon"></i>
                </div>
                <div class="remove-btn-wrapper"><button type="button" class="btn-danger"><i class="fas fa-trash-alt"></i></button></div>
                <div class="menu-item-category-manager">
                ...
                <div class="menu-item-fields">
                    ...
                    <div class="fields-grid">
                        ...
                        <div class="form-group"><label>السعر الجديد*</label><input type="number" name="deals[${idx}][new_price]" placeholder="الإدخال بالليرة السورية" class="form-control price-input price-live-update" required></div>
                        <div class="form-group"><label>السعر القديم</label><input type="number" name="deals[${idx}][old_price]" placeholder="الإدخال بالليرة السورية" class="form-control price-input"></div>
